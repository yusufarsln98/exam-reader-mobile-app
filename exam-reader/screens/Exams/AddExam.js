...
import { addClass, addExam, getClass, getClasses } from '../Home/dummy';
...
function AddExamScreen({ route, navigation }) {
  ...
  const addExamPressed = () => {
    if (selectedClass && examName && answerKey && questionCount) {
      addExam(selectedClass, examName, answerKey, questionCount);
      navigation.pop();
    }
  };
        ...
        <>
          <View style={[styles.inputItem]}>
            ...
            <Input
              ...
              placeholder={TR.add_exam.exam_name_example}
          ...
          <View style={[styles.inputItem]}>
            <Text style={[globalStyles.paragraph, { color: COLORS.softBlack, marginLeft: 8 }]}>
              {TR.add_exam.answer_key}
            </Text>
            <Input
              containerStyle={styles.inputContainer}
              style={styles.input}
              onChangeText={setAnswerKey}
              placeholder={TR.add_exam.answer_key_example}
              placeholderTextColor={COLORS.paleGray}
            >
            </Input>
          </View>
          <View style={[styles.inputItem]}>
            <Text style={[globalStyles.paragraph, { color: COLORS.softBlack, marginLeft: 8 }]}>
              {TR.add_exam.question_count}
            </Text>
            <Input
              containerStyle={styles.inputContainer}
              style={styles.input}
              onChangeText={setQuestionCount}
              placeholder={TR.add_exam.question_count_example}
              placeholderTextColor={COLORS.paleGray}
          ...
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'flex-end', right: 16 }}>
            <Button buttonStyle={[globalStyles.buttonPrimary, {
              width: 80,
              backgroundColor: examName && answerKey && questionCount && selectedClass ? COLORS.primary : COLORS.paleGray,
            }]} onPress={addExamPressed}>
